...
class TestKeyHandlerVisualMode < Minitest::Test
  ...
  class TestModeTransition < Minitest::Test
    ...
    def test_v_in_line_mode_toggles_to_char_mode
      line_selection = Mui::Selection.new(0, 0, line_mode: true)
      handler = Mui::KeyHandler::VisualMode.new(@window, @buffer, line_selection)
    ...
    def test_V_in_char_mode_toggles_to_line_mode
      result = @handler.handle("V")
    ...
    def test_V_in_line_mode_clears_selection
      line_selection = Mui::Selection.new(0, 0, line_mode: true)
      handler = Mui::KeyHandler::VisualMode.new(@window, @buffer, line_selection)
