...
class TestE2EVisualMode < Minitest::Test
  ...
  def test_visual_mode_indent_right
    runner = ScriptRunner.new
  ...
  def test_visual_line_multiple_indent
    runner = ScriptRunner.new
  ...
  def test_visual_mode_indent_skips_empty_lines
    runner = ScriptRunner.new

    runner
      .type("iLine1<Enter><Enter>Line3<Esc>")
      .type("gg")
      .type("V")
      .type("jj")
      .assert_mode(Mui::Mode::VISUAL_LINE)
  ...
  def test_visual_mode_indent_cursor_position
    runner = ScriptRunner.new
  ...
  def test_gv_restores_last_visual_selection
    runner = ScriptRunner.new
  ...
  def test_gv_restores_character_visual_selection
    runner = ScriptRunner.new
  ...
  def test_gv_after_indent_for_continuous_indent
    runner = ScriptRunner.new
  ...
  def test_gv_with_no_previous_selection
    runner = ScriptRunner.new
    ...
    runner
      ...
      .type("gv")
      .assert_mode(Mui::Mode::NORMAL)
      .assert_message_contains("No previous visual selection")
  end
end
